...
#End Region
    ...
    Private Sub btServicio_Click(sender As Object, e As EventArgs) Handles btServicio.Click
        ...
        frm._nameButton = btServicio.Name
        frm._modulo = FP_Configuracion
        Dim tab3 As SuperTabItem = superTabControl3.CreateTab(frm.Text)
        frm._tab = tab3
        Dim panel As Panel = P_Global._fnCrearPanelVentanas(frm)
    ...
    Private Sub btProformaServicio_Click(sender As Object, e As EventArgs) Handles btProformaServicio.Click
        SideNav1.IsMenuExpanded = False
        Ventana.Select()
        Dim frm As New F0_ProformaServicio
        frm._nameButton = btProformaServicio.Name
        Dim tab3 As SuperTabItem = superTabControl3.CreateTab(frm.Text)
        frm._tab = tab3
        frm._modulo = FP_VENTAS
        Dim panel As Panel = P_Global._fnCrearPanelVentanas(frm)
    ...
    Private Sub btVentaServicio_Click(sender As Object, e As EventArgs) Handles btVentaServicio.Click
        SideNav1.IsMenuExpanded = False
        Ventana.Select()
        Dim frm As New F0_VentasServicio
        frm._nameButton = btVentaServicio.Name
        Dim tab3 As SuperTabItem = superTabControl3.CreateTab(frm.Text)
        frm._tab = tab3
        frm._modulo = FP_VENTAS
        Dim panel As Panel = P_Global._fnCrearPanelVentanas(frm)
    ...
    Private Sub btCategorias_Click(sender As Object, e As EventArgs) Handles btCategorias.Click
        SideNav1.IsMenuExpanded = False
        Ventana.Select()
        Dim frm As New F1_CategoriaContable
        frm._nameButton = btCategorias.Name
        Dim tab3 As SuperTabItem = superTabControl3.CreateTab(frm.Text)
        frm._tab = tab3
        frm._modulo = FP_Configuracion
        Dim panel As Panel = P_Global._fnCrearPanelVentanas(frm)
